...
func setupTestDB() *sql.DB {
	db, err := sql.Open("mysql", "root@tcp(localhost:3306)/golang-rest-api-test")
...
func TestListCategoriesSuccess(t *testing.T) {
	...
	category2 := categoryRepository.Save(context.Background(), tx, domain.Category{Name: "Komputer"})
	tx.Commit()
